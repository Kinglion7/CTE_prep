/** Shared with Worker: strict JSON keys for Gemini / client validation. */
...
/** Shorter prompt: one casualty only (no multi-person reasoning). */
...
/** Full prompt: one object per distinct casualty. */
